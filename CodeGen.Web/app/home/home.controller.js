    ...
    $scope.generate = function () {
        ...
        if ($scope.collist.length > 0) {
            ...
            $http({
                ...
                $('#genCodeSql').text(''); $('#genCodeVm').text(''); $('#genCodeVu').text(''); $('#genCodeAPI').text('');
                $('#genCodeNode').text('');
                ...
                if (rowGen.length > 0) {
                    for (var i = 0; i < rowGen.length; i++) {
                        ...
                        //API
                            ...
                            document.getElementById(elementIDRepo).innerHTML += "// +++++++++ REPOSITORY Controller +++++++++ \r\n" + rowGen[i] + "\r\n";
                        else
